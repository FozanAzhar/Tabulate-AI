...
> "This is SpendSmart — a .NET MAUI expense tracker for INFT6009. The tagline is 'Less clutter, More clarity.' You snap a receipt, the app reads it with on-device OCR, and stores everything locally — no subscription, no cloud."

### 2. Scan and OCR (45 seconds)
...
6. Edit one field to show the fallback: "OCR isn't perfect — users always confirm before saving"
7. Tap **Save Receipt**
...
> "MVP is complete for Assignment 2. For the final submission I added search, charts, category suggestions, and fixes from usability testing."

## Troubleshooting during demo

| Problem | Fallback |
|---------|----------|
| OCR returns empty fields | Use **Manual Entry** from Scan tab |
...
- OCR: `Platforms/Windows/WindowsOcrService.cs`
